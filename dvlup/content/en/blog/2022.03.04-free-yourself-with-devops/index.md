...
thumbnail: 'AzureDevOpsIcon.png'
aliases:
  - /free-yourself-with-devops/
  - /2022/03/04/free-yourself-with-devops/
---
...
Note: You can learn more about that first PowerShell step in my other blog post on the topic [Using PowerShell to Install an SDK in a DevOps Build Pipeline – DVLUP](https://www.dvlup.com/2019/01/03/using-powershell-to-installing-msi-in-a-devops-build/).
...
![](PreconditionForSecondStage.png)
