...
1. Create a directory `mkdir mywordpress`
2. Shange to the directory `cd mywordpress`
3. Create a file using your favorite editor, for example `nano docker-compose.yml` 
4. Paste the following content (change the password), save and exit.
...
Done! You can now go to `http://localhost:82` and see the initial setup experience for WordPress. Just install the same Export/Import plugin you used to export the site and import your stuff.
