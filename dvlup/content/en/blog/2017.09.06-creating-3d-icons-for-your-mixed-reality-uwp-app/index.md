...
thumbnail: 'dogspin.gif'
aliases:
  - /creating-3d-icons-for-your-mixed-reality-uwp-app/
  - /2017/09/06/creating-3d-icons-for-your-mixed-reality-uwp-app/
---
...
{{< figure src="`objectproperties.png" caption="Outliner and Object properties editor" >}}
...
{{< figure src="`trianglecount.png" caption="Mesh Triangle Count" >}}
...
{{< figure src="`badlaunchermodel.png" caption="Invalid Model" >}}
...
{{< figure src="`exportoption.png" caption="Export as glb" >}}
...
{{< figure src="`filebuildaction.png" caption="File's Build Action" >}}
...
{{< figure src="`manifest.png" caption="Package.appxmanifest changes" >}}
...
[![](2017-09-05_21-17-42.png)](2017-09-05_21-17-42.png)
