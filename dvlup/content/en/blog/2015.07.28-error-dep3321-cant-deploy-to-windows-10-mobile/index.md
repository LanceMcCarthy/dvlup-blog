...
tags: ['tutorial']
aliases:
  - /error-dep3321-cant-deploy-to-windows-10-mobile/
  - /2015/07/28/error-dep3321-cant-deploy-to-windows-10-mobile/
thumbnail: 'deployerrorfeaturedimage.jpg'
---
...
4) Locate the `<TargetPlatformVersion\>` and `<TargetPlatformMinVersion\>` items in the first `<PropertyGroup\>`.
  ...
  * ![2015-07-28_1734](2015-07-28_1734.png))
