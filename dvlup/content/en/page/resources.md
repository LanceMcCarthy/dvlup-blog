...
* [Agify API](https://api.agify.io/?name=lance)
* [Amazon Web Services](http://aws.amazon.com/)
* [Associated Press API](https://developer.ap.org/)
...
* [Kenya Rest API](https://kanye.rest/)
* [LinkedIn](http://developer.linkedin.com/)
* [Marvel Comics API](https://developer.marvel.com/)
* [Meetup](http://www.meetup.com/meetup_api/)
* [NASA](https://api.nasa.gov/index.html) (highly recommended)
* [Naver Open API](https://developers.naver.com/main/)
* [NewsBlur](http://www.newsblur.com/api)
* [OMDb API](http://www.omdbapi.com/)
* [Open Library API](https://openlibrary.org/developers/api)
* [Open Weather API](https://openweathermap.org/api) (recommended)
...
* [SpaceX](https://github.com/r-spacex/SpaceX-API) (recommended)
* [Spotify API](https://developer.spotify.com/documentation/web-api/)
* [Stripe](https://stripe.com/)
* [The EchoNest](http://developer.echonest.com/)
* [Trivia API (jservice.io)](http://jservice.io/)
* [Twilio](http://www.twilio.com/)
* [Twitter](https://dev.twitter.com/)
* [USA.gov API endpoints, resources and documentation](http://www.usa.gov/About/developer-resources/developers.shtml#1usagov)
* [Vonage API](https://www.vonage.com/communications-apis/)
* [Website Screenshot API](https://screenshotapi.net/documentation)
* [Wolfram Alpha](http://products.wolframalpha.com/api/)
* [Xero](http://blog.xero.com/developer/api-overview/)
* [Zappos](http://developer.zappos.com/)

For more great APIs see [https://github.com/public-apis/public-apis](https://github.com/public-apis/public-apis).

## Windows 10 UWP Resources

Here are my recommended resources for building Windows UWP apps:
...
### Microsoft Virtual Academy courses for UWP
...
* [Windows Developer Show](http://windowsdevelopershow.com/) (formerly the WPDevShow. A must-listen!) and the companion [WindowsDevShow Newsletter](http://windowsdevelopernewsletter.com/)
...
* [Proximity Tapper add-on for WP emulator](http://proximitytapper.codeplex.com/) Must Have!
...
> More wpdev links continued after "getting started" section below
...
* **Windows Phone Design**
  ...
  * [Templarian's must-have Metro Icon set](http://modernuiicons.com/)
...
* [Compile in the the cloud!](http://www.silverlightshow.net/items/Windows-Phone-8-Compile-in-the-Cloud.aspx)
...
* [Windows Phone 8 SDK and using the emulator on a Virtual Machine](http://www.developer.nokia.com/Community/Wiki/Windows_Phone_8_SDK_on_a_Virtual_Machine_with_Working_Emulator)
...
* Using Mono to build your Windows Phone app? [See Shmueli Enlard's tip on importing resources.](http://blog.englard.net/post/41884729127/importingresourceswhenportingtomono)
...
* [Basic Networking support in Windows Phone 8](http://blogs.windows.com/windows_phone/b/wpdev/archive/2013/07/30/basic-networking-support-in-windows-phone.aspx) (WPDev blog)
...
* [SilverlightShow webinar on the new WP8 features](http://michaelcrump.net/silverlight-show-webinar-on-the-new-features-in-the-wp8-sdk-part-2)
...
* [A list of great build videos for WP8](http://michaelcrump.net/a-list-of-great-build-videos-for-windows-phone-8)
...
* [Speech Recognition](http://blogs.telerik.com/michaelcrump/posts/12-11-19/speech-recognition-made-easy-with-telerik-radcontrols-for-wp8.aspx)
* [MultiResolutionImage](http://blogs.telerik.com/michaelcrump/Posts/12-12-17/multi-resolution-support-in-windows-phone-8-made-easy)
* [DataForm](http://blogs.telerik.com/blogs/13-01-02/data-forms-no-problem-with-telerik-radcontrols-for-wp8) (Part 1)
* [DataForm](http://blogs.telerik.com/michaelcrump/Posts/13-01-07/windows-phone-8---persisting-conference-buddy-to-a-json-file) (Part 2)
* [Dynamic AppBars for Conference Buddy](http://blogs.telerik.com/michaelcrump/Posts/13-01-14/windows-phone-8-dynamic-appbars-for-conference-buddy)
